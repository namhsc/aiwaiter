	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto bg-[#FFF9F0] border-2 border-[#C4941D]/30">
				<DialogHeader>
					<DialogTitle className="text-[#3E2723] text-2xl">
						{dish.name}
					</DialogTitle>
				...
				<div className="space-y-3">
					...
					<div className="flex flex-wrap gap-2">
						{dish.popular && (
							<Badge className="bg-[#C4941D] text-white">⭐ Popular</Badge>
						)}
						{dish.vegetarian && (
						...
						{dish.prepTime && (
							<Badge
								variant="outline"
								className="border-[#C4941D]/30 text-[#8B7355]"
							>
							...
							<div className="space-y-2">
								...
								<div className="space-y-1.5">
									...
									<div className="flex justify-between text-sm">
										...
										<span className="text-[#3E2723]">
											{dish.nutritionalInfo.fiber}g
										</span>
									</div>
									<div className="flex justify-between text-sm">
										<span className="text-[#8B7355]">Sodium</span>
										<span className="text-[#3E2723]">
											{dish.nutritionalInfo.sodium}mg
										</span>
									</div>
								</div>
							</div>
