...
export function RestaurantLogo({ className = "", animate = false }: RestaurantLogoProps) {
      ...
      >
        ...
        <g transform="translate(60, 75)">
          ...
          <g transform="translate(-15, 0)">
            <line x1="0" y1="0" x2="0" y2="15" stroke="url(#goldGradient)" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="-3" y1="0" x2="-3" y2="8" stroke="url(#goldGradient)" strokeWidth="1" strokeLinecap="round" />
            <line x1="3" y1="0" x2="3" y2="8" stroke="url(#goldGradient)" strokeWidth="1" strokeLinecap="round" />
          </g>
