...
export function MenuScreen({
	...
	return (
		<div className="min-h-screen bg-[#FFF9F0] pb-32">
			...
			<div className="bg-white border-b border-[#C4941D]/20 px-4 py-4 shadow-sm sticky top-0 z-10">
				<div className="max-w-md mx-auto flex flex-col items-center gap-2">
					...
					<div className="text-center">
						<h1
							className="text-xl text-[#3E2723] leading-none"
							style={{ fontFamily: 'Georgia, serif' }}
						>
							Lumière <span className="text-[#C4941D]">Dorée</span>
						</h1>
						<p className="text-center text-[#8B7355] text-xs mt-1">
							Fine Dining Menu
						</p>
					</div>
				</div>
			...
			{/* AI Waiter Promotional Banner - Enhanced */}
			{showAIBanner && (
				<motion.div
				...
				>
					<div className="bg-gradient-to-br from-[#C4941D]/10 via-[#FFF4E0] to-[#D4A52D]/10 border-2 border-[#C4941D] rounded-2xl p-4 relative shadow-lg">
						<button
							onClick={() => setShowAIBanner(false)}
							className="absolute top-2 right-2 w-6 h-6 rounded-full bg-white/90 flex items-center justify-center text-[#8B7355] shadow-sm active:scale-95 transition-transform"
						>
							<X className="w-4 h-4" />
						</button>
						...
						<div className="flex gap-3 items-start">
							...
							<div className="relative">
								<div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#C4941D] to-[#D4A52D] flex items-center justify-center shrink-0 shadow-md">
							...
							<div className="flex-1 pr-6">
								<div className="flex items-center gap-2 mb-1">
									<h3 className="text-[#3E2723]">
										AI Waiter Available! <span className="text-lg">🤵</span>
									</h3>
									<Badge className="bg-[#C4941D] text-white text-xs px-2 py-0">
										New
									</Badge>
								</div>
								<p className="text-sm text-[#8B7355] mb-1 leading-relaxed">
					...
					<div className="max-w-md mx-auto flex items-center justify-between">
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<div className="text-lg text-[#3E2723]">
									€{cartTotal.toFixed(2)}
								</div>
							</div>
						</div>
