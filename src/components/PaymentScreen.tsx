...
export function PaymentScreen({
	...
	return (
		<div className="min-h-screen bg-[#FFF9F0] flex justify-center">
						...
						>
							...
							<div className="px-4 space-y-6">
								...
								<div className="bg-white rounded-2xl border-2 border-[#C4941D] p-6 shadow-sm">
									{discount > 0 && appliedVoucher ? (
										...
										<div className="text-center">
											<div className="text-[#8B7355] text-xs mb-2">
												Total Amount
											</div>
											<div className="text-[#C4941D] text-4xl">
												€{total.toFixed(2)}
								...
								<div className="space-y-3">
									<h2 className="text-[#3E2723] text-sm">
											...
											<div className="space-y-2">
												<div className="flex items-start gap-2">
													...
													<p className="text-[#3E2723] text-sm">
														Please prepare exact change or our staff will assist
														you with cash payment at your table
													</p>
												</div>
											</div>
										)}
										...
										{selectedMethod === 'card' && (
											<div className="space-y-2">
												<div className="flex items-start gap-2">
													<span className="text-xl">💳</span>
													<p className="text-[#3E2723] text-sm">
														A secure payment terminal will be brought to your
														table. All major credit and debit cards accepted.
													</p>
												</div>
											</div>
										)}
											...
											<div className="space-y-3">
												...
												<div className="flex items-start gap-2">
													...
													<p className="text-[#3E2723] text-sm text-center">
														Scan the QR code above with your mobile payment app
			...
			{/* Only show floating AI button before payment is complete */}
			{!isComplete && onOpenAI && (
				<motion.div
					initial={{ scale: 0 }}
					animate={{ scale: 1 }}
