	...
	return (
		<div className="bg-gradient-to-br from-[#FFF4E0] to-[#FFF9F0] rounded-xl p-6 border-2 border-[#C4941D]/30">
			<div className="text-center space-y-3">
				...
				<h4 className="text-xl text-[#C4941D]">{dish}</h4>
				<p className="text-[#3E2723] leading-relaxed max-w-lg mx-auto">
					{description}
				</p>
				<p className="text-sm text-[#8B7355] italic">{footer}</p>
			</div>
		</div>
	);
}
...
export function RestaurantStory({
	...
	const stories = {
		en: {
			...
			chefBio:
				'Trained at Le Cordon Bleu, Paris. 15 years experience in Michelin-starred restaurants.',
			chefQuote:
				'Food is poetry, technology is the pen. Together, we write stories worth savoring.',
			...
			signatureDesc:
				'A 24-karat gold-dusted dessert soufflé that rises tableside, paired with AI-recommended wine selections',
			signatureFooter:
				'Every dish is crafted with passion, every recommendation made with precision',
		...
		de: {
			...
			chefBio:
				'Ausgebildet am Le Cordon Bleu, Paris. 15 Jahre Erfahrung in Michelin-Stern-Restaurants.',
			chefQuote:
				'Essen ist Poesie, Technologie ist die Feder. Zusammen schreiben wir Geschichten, die es wert sind, genossen zu werden.',
			...
			signatureDish: "Le Chef's Golden Soufflé",
			signatureDesc:
				'Ein mit 24-Karat-Gold bestäubtes Dessert-Soufflé, das am Tisch aufsteigt, gepaart mit KI-empfohlenen Weinauswahlen',
			signatureFooter:
				'Jedes Gericht wird mit Leidenschaft zubereitet, jede Empfehlung mit Präzision gemacht',
		...
		zh: {
			...
			subtitle: '重新定义精致餐饮',
			intro:
				'成立于2024年，Lumière Dorée代表着悠久烹饪传统与尖端创新之间的完美和谐。',
			paragraph2:
				"我们的名字在法语中意为'金色之光'，象征着我们为现代餐饮带来的启迪。每次光临都让每位客人体验到我们厨师的艺术和AI侍酒师的智慧所照亮的美好时光。",
			visionTitle: '主厨Marie Laurent的愿景简单而革命性：',
			vision:
				'创造一种亲密的高级餐饮体验，在这里，技术增强而非取代人性化的服务。我们的AI服务员助手学习您的偏好，建议完美的搭配，确保每次光临都感觉是为您量身定制的。',
			...
			signatureDesc:
				'一款24K金粉装饰的甜点舒芙蕾，在桌边膨胀，搭配AI推荐的葡萄酒',
		...
		vi: {
			...
			vision:
				'tạo ra một trải nghiệm ẩm thực cao cấp thân mật, nơi công nghệ nâng cao chứ không thay thế sự chạm tay của con người. Trợ lý AI Waiter của chúng tôi học sở thích của bạn, đề xuất sự kết hợp hoàn hảo và đảm bảo mỗi lần ghé thăm đều cảm thấy được tùy chỉnh riêng.',
			chefName: 'Đầu bếp Marie Laurent',
			chefTitle: 'Đầu bếp điều hành & Đồng sáng lập',
			chefBio:
				'Được đào tạo tại Le Cordon Bleu, Paris. 15 năm kinh nghiệm tại các nhà hàng đạt sao Michelin.',
			chefQuote:
				'Thức ăn là thơ ca, công nghệ là cây bút. Cùng nhau, chúng ta viết nên những câu chuyện đáng để thưởng thức.',
			...
			values: [
				...
				},
				{
					title: 'Bền vững',
					description:
						'Nguyên liệu từ trang trại đến bàn ăn, bếp không chất thải',
					icon: 'leaf',
				},
				{
					title: 'Trải nghiệm',
			...
			signatureDish: "Le Chef's Golden Soufflé",
			signatureDesc:
				'Một món tráng miệng soufflé phủ bột vàng 24-karat nở ngay tại bàn, kết hợp với các lựa chọn rượu vang được AI đề xuất',
			signatureFooter:
				'Mỗi món ăn được chế biến với đam mê, mỗi đề xuất được thực hiện với độ chính xác',
					...
					>
						...
						<section className="space-y-3">
							<p className="text-[#3E2723] leading-relaxed">
								<span className="font-medium">{story.visionTitle}</span>{' '}
								{story.vision}
							</p>
						</section>
