...
const findMenuItems = (message: string): MenuItem[] => {
	...
	const keywords = [
		{ words: ['schnitzel', 'veal', 'cutlet'], item: 'Wiener Schnitzel' },
		{ words: ['bratwurst', 'sausage', 'nuremberg'], item: 'Bratwurst Platter' },
		{ words: ['pretzel', 'bavarian pretzel'], item: 'Bavarian Pretzel' },
		{
			words: ['sauerbraten', 'pot roast', 'beef marinated'],
			item: 'Sauerbraten',
		},
		{ words: ['rouladen', 'beef roll', 'beef rolls'], item: 'Rinderrouladen' },
		{ words: ['spätzle', 'spaetzle', 'noodles'], item: 'Käsespätzle' },
		{ words: ['potato salad', 'kartoffelsalat'], item: 'Kartoffelsalat' },
		{ words: ['flammkuchen', 'flatbread', 'alsatian'], item: 'Flammkuchen' },
		{ words: ['goulash', 'hungarian'], item: 'Hungarian Goulash' },
		{
		...
		{ words: ['riesling', 'white wine'], item: 'Riesling Wine' },
		{ words: ['espresso'], item: 'Espresso Doppio' },
		{ words: ['water', 'sparkling water'], item: 'Sparkling Water' },
	];
