...
export function expandQuickAction(action: string): string {
	...
	return formatted.endsWith('?') || formatted.endsWith('.')
		? formatted
		: formatted + '.';
}
...
export function getAllQuickActions(): QuickAction[] {
	return [
		...
		{
			keyword: 'Menu',
			expandedPhrase: 'I would like to see the full menu, please.',
			category: 'browsing',
		},
		{
			keyword: 'Starters',
			expandedPhrase: 'Could you show me your starters and appetizers, please?',
			category: 'browsing',
		},
		{
			keyword: 'Mains',
			expandedPhrase: 'Could you show me your main courses, please?',
			category: 'browsing',
		},
		{
			keyword: 'Desserts',
			expandedPhrase: 'I would like to see your dessert menu, please.',
			category: 'browsing',
		},
		{
			keyword: 'Drinks',
			expandedPhrase: 'Can you show me the drinks menu, please?',
			category: 'browsing',
		},
		{
			keyword: 'Kids Meals',
			expandedPhrase: 'What meals do you have for kids?',
			category: 'browsing',
		},
		{
			keyword: 'Diet Dishes',
		...
		{
			keyword: 'Healthy',
			expandedPhrase: 'I would like to see your healthy options.',
			category: 'browsing',
		},
		{
			keyword: 'Light Options',
			expandedPhrase: 'Could you show me lighter options, please?',
			category: 'browsing',
		},
		{
			keyword: 'Salads',
			expandedPhrase: 'What salad options do you have?',
			category: 'browsing',
		},
		{
			keyword: 'Vegetarian',
			expandedPhrase: 'Do you have vegetarian options?',
			category: 'browsing',
		},
		{
			keyword: 'Gluten-free',
			expandedPhrase: 'Could you show me gluten-free dishes, please?',
			category: 'browsing',
		},
		...
		{
			keyword: 'Popular',
			expandedPhrase: 'What are your most popular dishes?',
			category: 'browsing',
		},
		{
			keyword: 'Best Seller',
			expandedPhrase: 'What are your best selling dishes?',
			category: 'special',
		},
		{
			keyword: 'Specials',
			expandedPhrase: "What are today's specials?",
			category: 'special',
		},
		{
			keyword: 'Recommend',
			expandedPhrase: 'What would you recommend?',
			category: 'browsing',
		},
		...
		{
			keyword: 'Schnitzel',
			expandedPhrase: 'I would like to order the Wiener Schnitzel, please.',
			category: 'ordering',
		},
		...
		{
			keyword: 'My cart',
			expandedPhrase: 'Could you show me my cart, please?',
			category: 'ordering',
		},
		{
			keyword: 'Checkout',
			expandedPhrase: 'I would like to proceed to checkout.',
			category: 'payment',
		},
		...
		{
			keyword: 'Discount',
			expandedPhrase: 'Do you have any current discounts?',
			category: 'special',
		},
	];
}
...
export function getContextualQuickActions(
	context: 'initial' | 'browsing' | 'cart-empty' | 'cart-full' | 'ordering',
): string[] {
	const actions = {
		initial: [
			'Menu',
 ...
 */
export function getSpecialNoteActions(
	context: 'initial' | 'browsing' | 'cart-empty' | 'cart-full' | 'ordering',
): string[] {
	const actions = {
		initial: [
 ...
 */
export function getRecommendActions(
	context: 'initial' | 'browsing' | 'cart-empty' | 'cart-full' | 'ordering',
): string[] {
	const actions = {
		...
		'cart-full': ['Desserts', 'Drinks', 'Discount', 'Checkout'],
		ordering: ['Desserts', 'Drinks', 'Discount', 'Checkout'],
	};
